...
<div class="row">
			...
			<div class="col-md-6">		
						<div class="form-group">
							...
							<ul class="list-group">
									<li class="list-group-item"><p style="">1. Departamento </p> '. form_dropdown('C0CCDD', $depArray, FALSE,'class="form-control input200" id="C0CCDD"') .' </li>
									<li class="list-group-item"><p style="">2. Provincia </p> '. form_dropdown('C0CCPP', $provArray, FALSE,'class="form-control input200" id="C0CCPP"') .' <div class="help-block error"></div></li>
									<li class="list-group-item"><p style="">3. Distrito </p> '. form_dropdown('C0CCDI', $distArray, FALSE,'class="form-control input200" id="C0CCDI"') .' <div class="help-block error"></div></li>
									<li class="list-group-item"><p style="">4. Centro Poblado </p> '.form_input($C0NOMBRECP).'<div class="help-block error"></div></li>
							</ul>
			</div>		</div>
			...
			<div class="col-md-6">
							...
							<ul class="list-group">
									<li class="list-group-item"><p style="">5. Zona Nro </p> '. form_input($C0ZONNUM) .' </li>
									<li class="list-group-item"><p style="">6. Manzana Nro </p> '. form_input($C0MANZANA) .' <div class="help-block error"></div></li>
									<li class="list-group-item"><p style="">7. Aer Nro </p> '. form_input($C0AER) .' <div class="help-block error"></div></li>
							</ul>
						</div>	
...
$("#C0VOCCDD").change(function(event) {
        var sel = null;
        var urlx = null;
...
$("#C0VOCCPP").change(function(event) {
        var sel = null;
        var urlx = null;
